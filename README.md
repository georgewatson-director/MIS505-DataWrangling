...
The source data which PortfolioProject.py uses to produce its output was downloaded using the following links, Ones which CSU Global provided for this purpose.  They extracted the contents of these files from the bulk data which can be downloaded at the World Bank Group's open data bulk download page.
